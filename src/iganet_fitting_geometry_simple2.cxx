/**
   @file examples/src/iganet_fitting_geometry_simple.cxx
        ...
        for (int64_t nneurons :
          ...
          fitting<optimizer_t, inputs_t, outputs_t>
              net( // Number of neurons per layers
                  ...
                  activations,
                  // Number of B-spline coefficients of the inputs
                  // (=geometry), has to correspond to number of
                  // coefficients in input file
                  std::tuple{iganet::utils::to_array(25_i64, 25_i64)},
                  // Number of B-spline coefficients of the outputs
                  // (=solution)
